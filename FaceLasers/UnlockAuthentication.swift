...
//
//
//class UnlockAuthentication: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
//
//extension UnlockAuthentication {
...
//
//extension UnlockAuthentication: AVCaptureVideoDataOutputSampleBufferDelegate {
